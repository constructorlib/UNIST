...
// Task 1: Filter out data which contain null values
const filteredData = data.filter(
  (item) => item.date !== null && item.temperature !== null
);

// Task 2: Parse time data
filteredData.forEach((item) => {
  item.date = new Date(item.date);
});

// Task 3: Sort data in chronological order
